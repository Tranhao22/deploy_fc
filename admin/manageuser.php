...
/*this is delet quer*/
query("delete from user_info where user_id='$user_id'")or die("query is incorrect...");
}
	...
	<th><a href="adduser.php" class="btn btn-success">Add New</a></th>
                    ...
                    <tbody>
                      <?php 
                        ...
                        echo"<td>
                        <a href='edituser.php?action=edit&user_id=$user_id' type='button' rel='tooltip' title='' class='btn btn-info btn-link btn-sm' data-original-title='Edit User'>
